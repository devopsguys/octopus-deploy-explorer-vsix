// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompositePresentationEvent.cs" company="DevOpsGuys Ltd">
...
namespace DevOpsGuys.Vsix.Explorer.OctopusDeploy.Events
{
    ...
    internal class CompositePresentationEvent<TPayload> : EventBase
    {
        /// <summary>
        /// The UI dispatcher.
        /// </summary>
        ...
        /// <param name="threadOption">Specifies on which thread to receive the delegate.</param>
        /// <returns>
        /// A <see cref="SubscriptionToken" /> that uniquely identifies the added subscription.
        /// </returns>
        /// <remarks>
        ...
        /// If not using a WeakReference (<paramref name="keepSubscriberReferenceAlive" /> is <see langword="true" />), the user must explicitly call Unsubscribe for the event when disposing the subscriber in order to avoid memory leaks or unexpected behaviour.
        /// <para />
        /// The CompositePresentationEvent collection is thread-safe.
        /// </remarks>
        ...
        public virtual SubscriptionToken Subscribe(Action<TPayload> action, ThreadOption threadOption, bool keepSubscriberReferenceAlive, Predicate<TPayload> filter)
        {
            ...
            switch (threadOption)
            {
                ...
                case ThreadOption.UIThread:
                    subscription = new DispatcherEventSubscription<TPayload>(actionReference, filterReference, this.UIDispatcher);
                    break;
                default:
                    subscription = new EventSubscription<TPayload>(actionReference, filterReference);
                    break;
